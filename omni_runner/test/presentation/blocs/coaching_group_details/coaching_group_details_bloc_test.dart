...
const _group = CoachingGroupEntity(id: 'g1', name: 'Team', coachUserId: 'coach', createdAtMs: 0);
const _member = CoachingMemberEntity(id: 'm1', userId: 'u1', groupId: 'g1', displayName: 'U', role: CoachingRole.athlete, joinedAtMs: 0);
