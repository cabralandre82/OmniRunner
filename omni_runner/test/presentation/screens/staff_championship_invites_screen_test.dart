...
void main() {
  group('StaffChampionshipInvitesScreen', () {
    ...
    testWidgets('renders without crash', (tester) async {
      await tester.pumpApp(
        const StaffChampionshipInvitesScreen(groupId: 'g1'),
        wrapScaffold: false,
      );
    ...
    testWidgets('shows AppBar with correct title', (tester) async {
      ...
      expect(find.text('Convites de campeonatos'), findsOneWidget);
    ...
    testWidgets('shows error state when Supabase unavailable',
      ...
      expect(find.text('Erro ao carregar convites.'), findsOneWidget);
    });
  });
}
