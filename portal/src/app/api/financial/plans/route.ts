...
// parse, auth client crash) viram 500 INTERNAL_ERROR canônico em vez
// do legado `{ error: String(e) }` que vazava raw error messages.
export const POST = withErrorHandler(_post, "api.financial.plans.post");
export const DELETE = withErrorHandler(_delete, "api.financial.plans.delete");
