...
10. **Decisões arquiteturais**: `docs/DECISIONS_LOG.md` (99 decisões documentadas, incluindo billing, auto top-up, refunds, limites, strava-only, parks, social, push, polimento, liga, wrapped, running dna, backend audit, liga estadual, auditoria final).
...
*Gerado em 2026-02-18, atualizado em 2026-02-26 (Sprint 25.0.0 + Parks E2E + Backend Audit + Liga Admin + Liga Estadual + Auditoria Final) — 68 tabelas, 55 Edge Functions, 61 migrations, DECISAO 099*
