...
**Progresso Batch I (Reach goals):** 🟡 5 fixed + 5 wont-fix (Strava-only) / 12 — L22-04 🚫 wont-fix (código dormente em `6ef40ff`), L23-12 ✓ (fixed 2026-04-21 — athlete onboarding state machine), L20-06 ✓ (fixed 2026-04-21 — public status-page aggregator), L08-08 ✓ (fixed 2026-04-21 — audit_logs retention + partitioning primitives, commit `d64b72e`), L08-06 ✓ (fixed 2026-04-21 — OLAP staging layer `public_olap.*`, commit `06b4087`), L21-07/L21-08/L21-09/L21-11 🚫 wont-fix (Sprint 25.0.0 — Strava-only). Pendentes reais: L16-02, L21-10, L21-12.
...
| 50 | L08-06 | high | 8 | 3 | ✅ OLAP staging layer `public_olap.*` (MVs + pg_cron 15-min refresh) — dashboards `/platform/*` migram incrementalmente para as MVs (fixed 2026-04-21) |
